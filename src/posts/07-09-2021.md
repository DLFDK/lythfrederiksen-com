...
---
## Millionprojekt genopdager det, vi allerede vidste: Ventilation er vigtigt
...
Efter godt fire års målinger af hus og indeklima i samarbejde med Teknologisk Institut (TI) lander rapporten i 2019 med resultater, der har gjort EVD  “... rigtig meget klogere.”, som det hedder i det tilhørende nyhedsbrev. Generelt lægger rapportens konklusion og EVD’s efterfølgende formidling - eksempelvis via https://detaandbarehus.dk/ - op til, at hypotesen er bekræftet.
...
“EVD konkluderer på baggrund heraf, at det ser ud til, at fugt i størrelsesordenen op til 10 l/dag kan flyttes via diffusion gennem konstruktionen. Derved kan diffusionsåbne konstruktioner bidrage til at mindske behovet for ventilation.” (Egen Vinding og Datter, 2019a, s. 36)
...
Og så er der husets diffusionsmodstand. Den er straks sværere. Som sagt er rapporten ikke rig på detaljer, så den kræver lidt ekstra detektivarbejde at fastlægge. For at give EVD’s konklusion de bedste chancer har jeg søgt at fastlægge en Z-værdi, der repræsenterer den mest sandsynlige mindsteværdi for konstruktionen. Med andre ord er det højst usandsynligt, at diffusionsmodstanden i praksis har ligget lavere, og at fugttransport ved diffusion derfor har været højere. Mit bud er en gennemsnitlig Z-værdi på 7 GPa s m2/kg. Denne ganges op med husets overfladeareal, der bedømt ud fra rapportens tegninger ligger omkring 284 m2.
...
Ja, faktisk skal vi helt ned på 1,6 GPa s m2/kg, førend der kan transporteres så meget vand per døgn. Alene de 410 mm indblæst papiruld i testhuset har en Z-værdi 4 GPa s m2/kg (Papiruld Danmark, 2020).
...
Grafen viser den samlede fugttransport per døgn, hvis vi tager højde for både diffusion og exfiltration. Skal den ligge mellem 7 og 10 liter, kræver det et luftskifte mellem 0,15 h-1 og 0,24 h-1. Kan det lade sig gøre for testhuset, der jo helt bevidst er holdt lukket og så tæt som muligt?

Undervejs i projektet laver TI blandt andet to målinger af husets luftskifte, hvor anden måling foretages i den periode, jeg har udvalgt til analysen her. Den 20. november 2017 måles luftskiftet til 0,1 h-1 med sporgas. TI karakteriserer ikke vejrforholdene på dagen, så for at kunne bedømme, hvor godt de beskriver perioden som helhed, er det endnu engang vejrdata fra DMI, der skal i spil. Gennemsnittet af middeltemperatur og middelvind for tidsrummet 8-16 er henholdsvis 3,8 C og 1,8 m/s. For perioden som helhed ligger de to på 2,7 C og 4,3 m/s. Både temperatur og vind taler altså for, at luftskiftet i perioden i gennemsnit har ligget højere end 0,1 h-1.

Ved første måling med sporgas er resultatet et luftskifte på 0,4 h1 på en dag, hvor middeltemperatur og middelvind ligger på henholdsvis 11 C og 6,6 m/s. En simpel lineær interpolation mellem de to målinger baseret på middelvind giver et luftskifte på 0,25 h1 for perioden analyseret her, men hvor det dog bør bemærkes, at huset imellem de to målinger bliver tætnet yderligere. Den betydelige forskel i temperatur mellem de to komplicerer også sammenligningen.
...
Uagtet er vi dog allerede ved det målte luftskifte på 0,1 h-1 langt fra EVD’s konklusion. Hverken en analyse af Z-værdien eller luftskiftet kan sandsynliggøre, at det vitterligt udelukkende er ved diffusion, at de 7-10 L/døgn transporteres bort. 

Heller ikke hvis vi tillader luftfugtigheden at stige over de 10 g/m3, som er niveauet for testhuset i perioden, når fugttransporten ved diffusion nogensinde målsætningen. Z-værdien er simpelthen for høj til, at det kan lade sig gøre. Det, der skulle binde projektets hypotese sammen, er revet over.

“Vi har således fået bekræftet, at diffusion kan løse behovet for at få fugten ud af huset 100 %...” (Egen Vinding og Datter, 2019a, s. 10)
...
Man kan selvfølgelig vælge at klandre valget af materialer. Det tænker jeg er en blindgyde. For når EVD med sådan en iver har forsøgt at tage alle de rigtige valg og alligevel kan konstatere, at de skadelige stoffer finder vej indenfor, så tegner det altså ikke godt for Hr. og Fru Danmark, der går jo næppe går til opgaven med helt samme nidkærhed. Selv hvis vi vitterligt kunne fjerne alle kilder til problematiske stoffer fra et givent hus, så holder det kun til, der er udskiftning blandt beboerne. Hvad de nye ejere hiver indenfor, er der næppe et byggefirma, som vil stå til ansvar for.
...
Bygningsreglementet har naturligvis også en holdning til, hvor meget der bør ventileres. Her lyder kravet på 0,3 L/s m2, som omsat til testhuset bliver et luftskifte på 0,55 h1 - langt over det, der skal til for at komme af med 10 liter vand per døgn. Holder vi fast i den absolutte luftfugtighed fra testhuset (10 g/m3), kan der ved dette højere luftskifte ventileres mere end 17 liter bort per døgn. I praksis bliver situationen den, at luftfugtigheden i boligen falder indtil der igen er ligevægt mellem fugtbelastning og fugttransport.
...
På grafen ovenover er det spørgsmål besvaret. Den blå kurve repræsentere testhuset med dens gennemsnitlige Z-værdi på 7 GPa s m2/kg, og den røde kurve repræsenterer et hus af samme størrelse og udformning, der er absolut diffusionstæt. Her kan fugten altså kun slippe bort ved exfiltration og ventilation.
...
“Behovet for ventilation bliver dog væsentligt lavere i en diffusionsåben konstruktion end i en bygning med en diffusionstæt klimaskærm.” (Egen Vinding og Datter, 2019b, s. 2).
